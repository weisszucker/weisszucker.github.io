...
![Fun](Macro-Programming-Art/fun.jpg)
...
- 在进入宏函数前，所有 **宏参数** 会先进行一次 [**预扫描** _(prescan)_](https://gcc.gnu.org/onlinedocs/cpp/Argument-Prescan.html)，完全展开 **未用于** 拼接标识符 或 获取字面量 的所有参数
